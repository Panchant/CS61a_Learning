...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    playerone = player_score % 10
    opponenttens = opponent_score //10 % 10
    difference = abs(playerone - opponenttens)
    if  not difference :
        return 1
    else :
        return 3*difference 
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    """
    # BEGIN PROBLEM 4
    num = take_turn(num_rolls, player_score, opponent_score, dice)
    total = player_score + num
...
def always_roll(n):
    ...
    assert n >= 0 and n <= 10
    # BEGIN PROBLEM 6
    def strategy(player_score, opppnent_score):
        return n
    return strategy
    # END PROBLEM 6
...
def is_always_roll(strategy, goal=GOAL):
    ...
    """
    # BEGIN PROBLEM 7
    first_num = strategy(0,0)
    i = 0
    while i < goal : 
        j = 0
        while j < goal :
            test_num = strategy(i,j)
            if test_num != first_num:
                return False
            j += 1
        i += 1
    return True
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    num_dice = 1
    max_num = 1
    max_scoring = make_averaged(roll_dice,times_called)(num_dice, dice)
    while num_dice < 10 :
        num_dice += 1
        current_scoring = make_averaged(roll_dice,times_called)(num_dice,dice)
        if max_scoring < current_scoring:
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    boar_num = boar_brawl(score , opponent_score)
    if boar_num >= threshold :
        return 0
    else:
        return num_rolls
    # END PROBLEM 10
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    Suss Fuss rules."""
    # BEGIN PROBLEM 11
    sus_num = sus_update(0, score, opponent_score)
    if (sus_num - score ) >= threshold :
        return 0
    else :
        return num_rolls
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if score + boar_brawl(score, opponent_score ):
        return 0
    if score > opponent_score:
        return 1 
    zero_num = boar_brawl(score, opponent_score )
    six_num = make_averaged(roll_dice)(6,six_sided)
    if zero_num > six_num : 
        return 0
    return 6
    # END PROBLEM 12
